...
parser.add_argument('shear_file', type=str,
                    help='Shear catalog filename (with g1,g2,gtan,gx, etc.)')
...
def plot_binned_shear_calibration(match, bins=None, size=(16,6), outfile=None,
                           run_name=None, gridsize=50, fontsize=14,
                           radial_cut=None, limits=None, selection=None,
                           prefix=None, show=False, gtype='g1g2', **kwargs):
    '''
    ...
    if gtype == 'g1g2':
        ...
        raise ValueError('gtype must be either g1g2 or gtgx!')
    ...
    gmeas= {}
    gmeas['g1'] = shear[g1col]
    gmeas['g2'] = shear[g2col]
    ...
    for k, g in enumerate(['g1', 'g2']):
        ...
        ax.set_xlabel(f'True {g1col}')
        ax.set_ylabel(f'Meas {g2col}')
        ax.legend()
...
def main(args):
    ...
    for gtype in ['g1g2', 'gtgx']:
        ...
        #     match, 's2n_r_noshear', s2n_bins, gbins=gbins, outfile=outfile,
        #     run_name=run_name, show=show, gtype=gtype,
        #     )
        ...
        # plot_binned_bias_by_col(
        #     match, 'T_noshear', T_bins, gbins=gbins, outfile=outfile,
        #     run_name=run_name, show=show, gtype=gtype
        #     )
