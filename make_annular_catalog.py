...
class McalCats():
    ...
    def _make_table(self):
        ...
        gals_ind,master_ind,dist=master_matcher.match(ra=gals['ALPHAWIN_J2000'],dec=gals['DELTAWIN_J2000'],
                                                          radius=1E-4,maxmatch=1)
        print("%d/%d objects matched to reference sexcat" %(len(gals_ind),len(self.mcCat)))
        ...
        newtab.add_columns([match_master['X_IMAGE'],match_master['Y_IMAGE']],names=['X_IMAGE','Y_IMAGE'])
