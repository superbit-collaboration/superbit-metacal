...
science = glob.glob('/Users/jemcclea/Research/GalSim/examples/output-debug/mockSuperbit_shear_300_?.fits')
...
try:
    ...
    bm.set_working_dir(path='debug3-kron')
    bm.set_path_to_psf(path='debug3-kron/psfex_output')
    ...
    bm.run(clobber=False,source_selection = True, select_from_gaia=False,outfile = "debug3-kron/debug-0.538-PSFscale.meds")
